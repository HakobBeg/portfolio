...
window.PORTFOLIO_DATA = {
  ...
  skills: {
    ...
    items: [
      { name: "Angular",        category: "Framework",    level: 96, desc: "Standalone components, signals, route-level code-splitting, SSR with Hydration." },
      { name: "React",          category: "Framework",    level: 88, desc: "Hooks, Suspense, server components, and shipping production apps with Next.js."  },
      ...
      { name: "RxJS",           category: "Reactivity",   level: 92, desc: "Higher-order observables, custom operators, real-time data pipelines."           },
      { name: "NgRx",           category: "State",        level: 88, desc: "Feature stores, effects, entity adapters; lately leaning on Signal Store."       },
      { name: "NestJS",         category: "Backend",      level: 82, desc: "REST & GraphQL APIs, dependency injection, queue-driven workers."                },
      { name: "Microfrontends", category: "Architecture", level: 86, desc: "Module Federation, Native Federation, design-system handoff between teams."      },
      { name: "PostgreSQL",     category: "Database",     level: 78, desc: "Schema design, indexing, query plans, pgBouncer, read-replica routing."          },
      { name: "MySQL",          category: "Database",     level: 76, desc: "Relational modelling, performance tuning, transactional workloads at scale."      },
      { name: "Docker",         category: "Tooling",      level: 80, desc: "Multi-stage builds, slim images, local dev parity with production."               },
      { name: "CI / CD",        category: "DevOps",       level: 84, desc: "GitHub Actions, GitLab CI, preview environments, automated visual regression."   },
    ],
  },
  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        company: "Independent / Educational Programs",
  ...
  projects: {
    ...
    lede:    "Selected from the last three years. Hover to peek under the hood.",
    items: [
      {
        kicker: "Fintech · Microfrontend",
        title:  "Lattice Trading Console",
        desc:   "A real-time multi-asset trading dashboard with sub-50ms tick latency and a federated widget marketplace.",
        url:    "#",
        tags:   ["Angular 17", "Module Federation", "RxJS", "D3"],
        extra:  [{ label: "Role", value: "Lead FE" }, { label: "Team", value: "9 engineers" }, { label: "Year", value: "2024" }],
      },
      {
        kicker: "Health · Patient portal",
        title:  "Northwind Care",
        desc:   "Full-stack rewrite of a HIPAA-compliant patient portal — appointments, telehealth, prescriptions and billing in one focused experience.",
        url:    "#",
        tags:   ["Angular", "NestJS", "PostgreSQL", "WebRTC"],
        extra:  [{ label: "Role", value: "Tech lead" }, { label: "Users", value: "1.2M" }, { label: "Year", value: "2022" }],
      },
      {
        kicker: "Open source · Library",
        title:  "ng-quanta",
        desc:   "An Angular utility library for building motion-rich UI on top of the Web Animations API. Used in production by a handful of teams.",
        url:    "#",
        tags:   ["Angular", "TypeScript", "WAAPI", "Rollup"],
        extra:  [{ label: "Role", value: "Author" }, { label: "Stars", value: "1.4k" }, { label: "Year", value: "2023" }],
      },
      {
        kicker: "SaaS · Analytics",
        title:  "Beacon Insights",
        desc:   "Multi-tenant product analytics with realtime cohorting. Built the streaming chart engine that handles 100k+ events/min per tenant.",
        url:    "#",
        tags:   ["Angular", "RxJS", "WebSockets", "Canvas"],
        extra:  [{ label: "Role", value: "Senior FE" }, { label: "Stage", value: "Series B" }, { label: "Year", value: "2020" }],
      },
    ],
  },
